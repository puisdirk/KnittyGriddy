...
import 'package:knitty_griddy/controls/pattern_chooser/move_stitch_to_set_menu.dart';
...
class StitchSetPanel extends StatefulWidget {
  final StitchSet stitchSet;
  
  const StitchSetPanel({
    required this.stitchSet,
    super.key
  });

  @override
  State<StitchSetPanel> createState() => _StitchSetPanelState();
}

class _StitchSetPanelState extends State<StitchSetPanel> {
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      if (StitchRepository.instance.sets.length > 1)
                        MoveStitchToSetMenu(stitchDefinition: def, currentStitchSet: widget.stitchSet),
                      IconButton(
                        onPressed: () {
